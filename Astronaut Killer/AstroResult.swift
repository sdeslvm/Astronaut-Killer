...
protocol AstroWebStatusComparable {
...
enum AstroWebStatus: Equatable, AstroWebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: AstroWebStatus) -> Bool {
        switch (self, other) {
...
extension AstroWebStatus {
    static func == (lhs: AstroWebStatus, rhs: AstroWebStatus) -> Bool {
